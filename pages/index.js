...
export default function Home() {
  ...
  //State variable to switch between the 'Create Proposals' and 'View Proposals' tabs
  ...
  const numOfProposalsInDAO = useContractReas({
    abi: CryptoDevsDAOABI,
    address: CryptoDevsDAOAddress,
  ...
  // Used to re-fetch all proposals in the DAO when user switches to the 'View Proposal
  useEffect(() => {
